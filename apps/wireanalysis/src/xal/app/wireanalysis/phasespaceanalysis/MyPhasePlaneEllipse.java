package xal.app.wireanalysis.phasespaceanalysis;
...
public class MyPhasePlaneEllipse {
     ...
     */
    public MyPhasePlaneEllipse( double emitt, double alpha, double beta ) {
        this.emitt = emitt;
        this.alpha = alpha;
        this.beta = beta;
    ...
    public void calcCurvePoints() {
	 ...
	 /**  Calculates (x,xp) points for graphic presentation. *///liyong add
    public void calcCurvePoints(double x0,double xp0) {
        curveData.clear();
        double phi;
        double x;
        double xp;
     ...
     */
    public MyPhasePlaneEllipse getNewPhasePlaneEllipse( double emmitNew ) {
    	MyPhasePlaneEllipse phe = new MyPhasePlaneEllipse( emmitNew, getAlpha(), getBeta() );
     ...
     *@return    The newPhasePlaneEllipse value
     */
    public MyPhasePlaneEllipse getNewPhasePlaneEllipse() {
    	MyPhasePlaneEllipse phe = new MyPhasePlaneEllipse( getEmittance(), getAlpha(), getBeta() );
        phe.calcCurvePoints( this.getNumberCurvePoints() );
        return phe;
    }
