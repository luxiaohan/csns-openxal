...
import xal.extension.fit.lsm.Gaussian;
...
public class AnalysisPanel extends JPanel{
    ...
    public void addComponents(){
		...
		layout.add(removebutton, mainPanel, 10, 270, EdgeLayout.LEFT);
		layout.add(hnormpanel, mainPanel, 5, 305, EdgeLayout.LEFT);
		layout.add(centerpanel, mainPanel, 5, 345, EdgeLayout.LEFT);
		layout.add(vnormpanel, mainPanel, 5, 380, EdgeLayout.LEFT);
		layout.add(vcutpanel, mainPanel, 5, 415, EdgeLayout.LEFT);
		layout.add(voffsetpanel, mainPanel, 5, 450, EdgeLayout.LEFT);
