 ...
 * 
 * @author chu, Zp
 * @Adapted from the class NonConsecutiveSeqSelector
 * 
 */

public class TransLineSeqSelector implements ActionListener {
	...
	class MyTableModel extends AbstractTableModel {
		...
		final Object[][] data = { 
//				{ "LEBT", new Boolean(false) },
//				{ "RFQ", new Boolean(false) },
				
				{ "MEBT", new Boolean(false) },	
				
//				{ "DTL1", new Boolean(false) },
//				{ "DTL2", new Boolean(false) },
//				{ "DTL3", new Boolean(false) },
//				{ "DTL4", new Boolean(false) },
				
				{ "LRBT_PreMatch", new Boolean(false) },
				{ "LRBT_TripCels", new Boolean(false) },
				// Doublets ,no WSs
				{ "LRBT_Doublets", new Boolean(false) },
				
				{ "LRBT_SW2injFoil", new Boolean(false) },
				{ "LRBT_injFoil2injDump", new Boolean(false) },
				{ "LRBT_LDump", new Boolean(false) },

				{ "RTBT1", new Boolean(false) },
				{ "RTBT_FODO", new Boolean(false) },
				{ "RTBT_Match", new Boolean(false) },
				{ "RTBT_RDump", new Boolean(false) }
		};
