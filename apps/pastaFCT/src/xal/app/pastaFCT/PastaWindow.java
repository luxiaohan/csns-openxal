...
public class PastaWindow extends AcceleratorWindow {
    ...
    private JList<AcceleratorNode> BPM1List, BPM2List, cavityList, BCMList;// ,
                                                                           // algorithmList;
    ...
    /**
     * a pane; to hold radio buttons to select the scan curve for which the
     * cavity voltage applies
     */
    ...
    protected DoubleInputTextField timeoutTextField, minScanPhaseField,
            maxScanPhaseField, minBPMAmpField, nModelStepsField,
            DTLPhaseOffsetField, BPMPhaseDiffOffsetField;
    protected JTextField errorField;

    // buttons to remove scan points
    protected JButton removeCavOnPointButton = new JButton(
            "Remove One Scan Point");
    protected JButton removeCavOffPointButton = new JButton(
            "Remove One Scan Point");
    ...
    public PastaWindow(PastaDocument aDocument) {
        ...
        setSize(950, 825);
        theDoc = aDocument;
        BPM1List = new JList<AcceleratorNode>();
        BPM2List = new JList<AcceleratorNode>();
        cavityList = new JList<AcceleratorNode>();
        BCMList = new JList<AcceleratorNode>();
        ...
        BPM1ListLabel = new JLabel("FCT 1");
        BPM1ListLabel.setHorizontalAlignment(SwingConstants.CENTER);
        BPM2ListLabel = new JLabel("FCT 2");
        ...
        graphAnalysis.setName("Analysis : FCT Phase Difference vs. Cavity Phase");
        graphAnalysis.setAxisNames("Cavity Phase (deg)", "FCT Phase Diff (deg)");
    ...
    private void makeAnalysisPanel() {
        ...
        /*
         * useBPM1Box = new JCheckBox("Use BPM1", true); useBPM2Box = new
         * JCheckBox("Use BPM2", true); useCavOffBox = new
         * JCheckBox("Use Cav Off", true); GridBagConstraints gbc = new
         * GridBagConstraints(); gbc.fill = GridBagConstraints.NONE; gbc.weightx
         * = 0.; gbc.weighty = 0.; gbc.gridx = 0; gbc.gridy = sumy;
         * gbc.gridwidth = 1; anGridBag.setConstraints(useBPM1Box, gbc);
         * analysisSetupPanel.add(useBPM1Box); gbc.gridx = 1; gbc.gridy = sumy;
         * anGridBag.setConstraints(useBPM2Box, gbc);
         * analysisSetupPanel.add(useBPM2Box); gbc.gridx = 2; gbc.gridy =
         * sumy++; anGridBag.setConstraints(useCavOffBox, gbc);
         * analysisSetupPanel.add(useCavOffBox);
         */
        JPanel checkBoxPanel = new JPanel();
        useBPM1Box = new JCheckBox("Use FCT1", true);
        useBPM2Box = new JCheckBox("Use FCT2", true);
        ...
        gbc.weightx = 1.;
        gbc.weighty = 0.;
        JLabel minBPMAmpLabel = new JLabel("Minimum FCT Amplitude (mA) : ");
        gbc.gridx = 0;
        gbc.gridy = sumy;
        ...
        /*
         * // BPM phase offset gbc.gridwidth = 1; gbc.weightx = 1.; gbc.weighty
         * = 0.; JLabel BPMPhaseOffsetLabel = new
         * JLabel("Offset in Y (deg) : "); gbc.gridx = 0; gbc.gridy = sumy;
         * anGridBag.setConstraints(BPMPhaseOffsetLabel, gbc);
         * analysisSetupPanel.add(BPMPhaseOffsetLabel);
         * 
         * gbc.weightx = 0.; gbc.weighty = 1.; gbc.gridx = 1; gbc.gridy =
         * sumy++; BPMPhaseDiffOffsetField = new DoubleInputTextField( (new
         * Double(theDoc.BPMPhaseDiffOffset)).toString());
         * BPMPhaseDiffOffsetField.addActionListener(new
        ...
        minScanPhaseField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                theDoc.analysisStuff.phaseModelMin = minScanPhaseField
                        .getValue();
        ...
        maxScanPhaseField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                theDoc.analysisStuff.phaseModelMax = maxScanPhaseField
                        .getValue();
                theDoc.analysisStuff.makeCalcPoints();
            }
        });
        ...
        timeoutTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                theDoc.analysisStuff.timeoutPeriod = timeoutTextField
                        .getValue();
            }
        });
         ...
         * // algorithm chooser
         * 
         * gbc.weightx = 0.; gbc.weighty = 0.; JLabel algorithmLabel = new
         * JLabel("Algorithm : "); gbc.gridx = 0; gbc.gridy = sumy;
         * anGridBag.setConstraints(algorithmLabel, gbc);
         * analysisSetupPanel.add(algorithmLabel);
         * 
         * gbc.weightx = 1.; gbc.weighty = 1.; gbc.gridx = 1; gbc.gridy =
         * sumy++; anGridBag.setConstraints(algorithmChooser, gbc);
         * analysisSetupPanel.add(algorithmChooser);
         * algorithmChooser.addActionListener(new
         * java.awt.event.ActionListener() { public void
         * actionPerformed(java.awt.event.ActionEvent evt) {
         * theDoc.analysisStuff.algorithmId = ((String)
         * algorithmChooser.getSelectedItem()); } });
         * 
         * // probe file chooser
         * 
         * gbc.gridwidth = 1; gbc.weightx = 1.; gbc.weighty = 0.; JLabel
         * probeChooserLabel = new JLabel("Pick a Probe"); gbc.gridx = 0;
         * gbc.gridy = sumy; anGridBag.setConstraints(probeChooserLabel, gbc);
         * analysisSetupPanel.add(probeChooserLabel);
         * 
         * gbc.weightx = 0.; gbc.weighty = 1.; gbc.gridx = 1; gbc.gridy =
         * sumy++; JButton probeChooserButton = new JButton("Probe"); jfc = new
         * JFileChooser(theDoc.analysisStuff.probeFile);
         * probeChooserButton.addActionListener(new
         * java.awt.event.ActionListener() { public void
         * actionPerformed(java.awt.event.ActionEvent evt) { int result =
         * jfc.showOpenDialog(theDoc.myWindow()); if(result ==
         * JFileChooser.APPROVE_OPTION) { theDoc.analysisStuff.probeFile =
         * jfc.getSelectedFile();
         * theDoc.analysisStuff.setProbe(theDoc.analysisStuff.probeFile); //
         * make sure that RF phase is calculated
         * //(theDoc.analysisStuff.theProbe
         * .getAlgorithm()).setRfGapPhaseCalculation(true); } } });
        ...
        setPntButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                String ans = "Phase = "
                        + spFormat
                                .format(theDoc.analysisStuff.cavPhaseSetpoint)
                        + "\nAmp  = "
                        + spFormat.format(theDoc.analysisStuff.cavAmpSetpoint)
                        + "\nWOut (MeV) = "
                        + spFormat.format(theDoc.analysisStuff.WOutCalc);
        ...
        plotWOutButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                if (theDoc.analysisStuff.haveData)
    ...
    protected void updateSelectionLists() {
        BPM1List.removeAll();
        BPM2List.removeAll();
        cavityList.removeAll();
        BCMList.removeAll();
        
        BPM1List.setListData(theDoc.getFCTs().toArray(new AcceleratorNode[0]));
        BPM2List.setListData(theDoc.getFCTs().toArray(new AcceleratorNode[0]));
        cavityList.setListData(theDoc.getCavities().toArray(new AcceleratorNode[0]));
        BCMList.setListData(theDoc.getBCMs().toArray(new AcceleratorNode[0]));
    }

    public JList<AcceleratorNode> getBPM1List() {
        return BPM1List;
    }

    public JList<AcceleratorNode> getBPM2List() {
        return BPM2List;
    }

    public JList<AcceleratorNode> getCavityList() {
        return cavityList;
    }

    public JList<AcceleratorNode> getBCMList() {
        return BCMList;
    }
    ...
    protected void setAccelComponents() {
        ...
        FCT BPM1 = (FCT) BPM1List.getSelectedValue();
        FCT BPM2 = (FCT) BPM2List.getSelectedValue();
        RfCavity cav = (RfCavity) cavityList.getSelectedValue();

        if (BPM1 == null || BPM2 == null || cav == null) {
            Toolkit.getDefaultToolkit().beep();
            errorText.setText("Hey - you need to select both FCTs and the cavity to use");
            Application.displayError("Pasta Information", "Two FCTs and a cavity must be selected!");
            return;
        }
        if (BPM1 == BPM2) {
            Toolkit.getDefaultToolkit().beep();
            errorText.setText("Hey - you need to select unique FCTs");
            Application.displayError("Pasta Information", "The FCTs must be different!");
            return;
        }
        if (theDoc.getSelectedSequence().getPosition(BPM1) < theDoc.getSelectedSequence().getPosition(cav)
                || theDoc.getSelectedSequence().getPosition(BPM2) < theDoc.getSelectedSequence().getPosition(cav)) {
            Toolkit.getDefaultToolkit().beep();
            errorText.setText("Hey - the FCTs must be downstream of the cavity");
            Application.displayError("Pasta Information", "The FCTs must be downstream of the cavity!");
            return;
        }

        theDoc.setFCT1(BPM1);
        theDoc.setFCT2(BPM2);
        theDoc.setCavity(cav);
        ...
        System.out.println("FCT1 = " + BPM1.getId());
        System.out.println("FCT2 = " + BPM2.getId());
        ...
        // make a model
        try {
            theDoc.analysisStuff.setModel(Scenario.newScenarioFor(theDoc.theSequence));
            ...
            Application.displayError("Pasta Information", "Couldn't set up the model for your selected sequence!");
            return;
        }
    ...
    protected void updateDesignValLabel() {
        String label = "Design phase (deg) = " + theDoc.getCavityDesignPhase();
        label += "\nDesign Amp (MV/m) = " + theDoc.getCavityDesignAmp();
    ...
    public String prettyString(double num) {
        ...
        if (Math.abs(num) > 10000. || Math.abs(num) < 0.1) fieldFormat = new DecimalFormat("0.000E0");
        else fieldFormat = new DecimalFormat("#####.#");
    ...
    /**
     * set up the panel to display radio buttons for selecting the scans to
     * analyze
     */
    ...
    protected void updateInputFields() {
        ...
        if (theDoc.analysisStuff.amplitudeVariableIndex > 0)
            updateScanNumberSelector();
    }

    /**
     * plot the measured data to the graphPanel * any existing data is removed
     */
    protected void plotMeasuredData() {
        ...
        for (int i = 0; i < theDoc.analysisStuff.phasesCavMeasured.size(); i++) {
            ...
            curveDataMeasured.setGraphProperty("Legend", "Measured diff " + caseNum);
            curveDataMeasured.setGraphColor(IncrementalColors.getColor(i));
    ...
    /**
     * plot the model data to the graphPanel * any existing data is retained
     */
        ...
        for (int i = 0; i < theDoc.useScanInMatch.size(); i++) {
            if (((Boolean) theDoc.useScanInMatch.get(i)).booleanValue()) {
                ...
                if (theDoc.analysisStuff.WOutsV.get(new Integer(i)) == null) {
                    String errText = "Oh no!, The model Wout and FCT phase containers are different sizes\n - I can't plot this";
                    theDoc.myWindow().errorText.setText(errText);
                    System.err.println(errText);
                    return;
                }
                ...
                String caseNum = (new Integer(i)).toString();
                curveDataModel.setGraphProperty("Legend", "Model diff "
                        + caseNum);
                ...
                WOutModel.setGraphProperty("Legend", "Model diff " + caseNum);
                WOutModel.setGraphColor(IncrementalColors.getColor(i));
