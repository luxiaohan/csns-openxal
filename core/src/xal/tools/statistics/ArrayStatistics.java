 ...
 *
 * Created on August 19, 2002, 9:15 AM
 */
...
public class ArrayStatistics {
    protected int[] dimensions;     // array of sizes (one for each dimension)
    protected int population;       // number of samples
    protected Object mean, meanSquare;          // the mean and mean square arrays
